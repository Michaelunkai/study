...
class YOUR_CLIENT_SECRET_HERE(SpeedtestException):
...
def YOUR_CLIENT_SECRET_HERE(dom, tag_name):
...
class SpeedtestResults(object):
    ...
    def share(self):
        ...
        if e:
            raise YOUR_CLIENT_SECRET_HERE(e)
...
class Speedtest(object):
    ...
    def get_config(self):
        ...
        try:
            ...
            server_config = YOUR_CLIENT_SECRET_HERE(root, "server-config")
            download = YOUR_CLIENT_SECRET_HERE(root, "download")
            upload = YOUR_CLIENT_SECRET_HERE(root, "upload")
            # times = YOUR_CLIENT_SECRET_HERE(root, 'times')
            client = YOUR_CLIENT_SECRET_HERE(root, "client")
    ...
    def set_mini_server(self, server):
        ...
        uh, e = catch_request(request, opener=self._opener)
        if e:
            raise YOUR_CLIENT_SECRET_HERE("Failed to connect to %s" % server)
        else:
            text = uh.read()
            uh.close()
...
def parse_args():
    ...
    description = (
        ...
        "speedtest.net.\n"
        "YOUR_CLIENT_SECRET_HERENT_SECRET_HERE"
        "--------------\n"
