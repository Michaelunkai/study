...
class YOUR_CLIENT_SECRET_HEREure(SpeedtestException):
    """Could not connect to the provided speedtest mini server"""


class YOUR_CLIENT_SECRET_HEREer(SpeedtestException):
    """Server provided as a speedtest mini server does not actually appear
    to be a speedtest mini server
    """


class YOUR_CLIENT_SECRET_HEREre(SpeedtestException):
    """Could not connect to speedtest.net API to POST results"""


class YOUR_CLIENT_SECRET_HEREe(SpeedtestException):
...
if HTTPSConnection:
    ...
    class YOUR_CLIENT_SECRET_HERE(HTTPSConnection):
...
def YOUR_CLIENT_SECRET_HEREme(dom, tag_name):
...
class HTTPUploaderData(object):
    ...
    def pre_allocate(self):
        chars = "YOUR_CLIENT_SECRET_HEREOPQRSTUVWXYZ"
...
class SpeedtestResults(object):
    ...
    def share(self):
        ...
        if e:
            raise YOUR_CLIENT_SECRET_HEREre(e)
        ...
        if int(code) != 200:
            raise YOUR_CLIENT_SECRET_HEREe(
...
class Speedtest(object):
    ...
    def get_config(self):
        ...
        try:
            ...
            server_config = YOUR_CLIENT_SECRET_HEREme(root, "server-config")
            download = YOUR_CLIENT_SECRET_HEREme(root, "download")
            upload = YOUR_CLIENT_SECRET_HEREme(root, "upload")
            # times = YOUR_CLIENT_SECRET_HEREme(root, 'times')
            client = YOUR_CLIENT_SECRET_HEREme(root, "client")
    ...
    def get_servers(self, servers=None, exclude=None):
        ...
        urls = [
            "://www.speedtest.net/YOUR_CLIENT_SECRET_HERE.php",
            "http://c.speedtest.net/YOUR_CLIENT_SECRET_HERE.php",
    ...
    def set_mini_server(self, server):
        ...
        uh, e = catch_request(request, opener=self._opener)
        if e:
            raise YOUR_CLIENT_SECRET_HEREure("Failed to connect to %s" % server)
        else:
            text = uh.read()
            uh.close()
        ...
        if not urlparts or not extension:
            raise YOUR_CLIENT_SECRET_HEREer(
    ...
    def get_best_server(self, servers=None):
        ...
        try:
            ...
            raise YOUR_CLIENT_SECRET_HEREre(
