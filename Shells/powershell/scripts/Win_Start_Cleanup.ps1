...
param(
    ...
    Get-ChildItem "C:\users\misha\AppData\Local\Temp\*" -Recurse -Force -ErrorAction SilentlyContinue |
    ...
    Get-ChildItem "C:\users\misha\AppData\Local\Microsoft\Windows\Temporary Internet Files\*" `
