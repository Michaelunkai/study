# Remade Script: Ubuntu_Automation_Setup_Alias_Export_backitup_backitup.ps1
...
# Launch WSL Ubuntu and perform Docker commands
...
# One-liner to run in Ubuntu after all other commands
Run-WSLCommand "cd /mnt/c/Users/micha/Videos/Webinars && docker run michadockermisha/backup:webinars sh -c 'apk add rsync && rsync -av /home/* /c/Users/micha/Videos/Webinars && exit' && docker build -t michadockermisha/backup:webinars . && docker push michadockermisha/backup:webinars && rm -rf ./*"
