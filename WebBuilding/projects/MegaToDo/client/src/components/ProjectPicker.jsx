...
/**
 * ProjectPicker �" standalone dropdown for selecting a project or section.
 * Self-fetches projects + sections from GET /api/projects on mount.
 *
 * Props:
 *   value       {string} selected project id or section id ('' = no project)
 *   selectedId  {string} alias for value �" id of the currently selected project/section
 *   onChange    {fn}     called with { projectId, sectionId } �" sectionId may be null
...
export default function ProjectPicker({
  ...
  const [sectionsMap, setSectionsMap] = useState({}) // projectId �' Section[]
  const [loading, setLoading] = useState(true)
  const [highlightedIndex, setHighlightedIndex] = useState(-1)
  const containerRef = useRef(null)

  // �"��"� Fetch projects + their sections on mount �"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"�
  useEffect(() => {
    let cancelled = false
    ...
    async function loadData() {
      ...
      try {
        ...
        const res = await fetch(`${apiBase}/api/projects`, { headers: authHdr })
  ...
  // �"��"� Keyboard navigation: ArrowDown/Up move highlight, Enter selects, Escape closes �"��"�
  useEffect(() => {
  ...
  // �"��"� Derive display label and color from current value �"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"�
            ...
            return projects.map((project) => {
              ...
              return (
                <li key={project.id} role="none">
                  ...
                  {/* Section rows �" indented under parent project */}
                  {sections.map((section) => {
                    ...
                    return (
                      ...
                      >
                        {/* Section icon �" lines indicating a section */}
                        <svg
