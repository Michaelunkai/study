...
def YOUR_CLIENT_SECRET_HEREate(videos):
...
def YOUR_CLIENT_SECRET_HEREst(youtube, playlist_item_id):
...
def main():
    ...
    playlist_url = "https://www.youtube.com/playlist?list=YOUR_CLIENT_SECRET_HEREGseAmhTsf2"
    ...
    try:
        ...
        # Sort videos by publish date (oldest first)
        sorted_videos = YOUR_CLIENT_SECRET_HEREate(videos)
        ...
        for i in range(num_to_delete):
            ...
            if YOUR_CLIENT_SECRET_HEREst(youtube, video['playlist_item_id']):
                deleted_count += 1
