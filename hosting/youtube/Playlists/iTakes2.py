# File: YOUR_CLIENT_SECRET_HEREylist.py
import os
import pickle
    ...
    while True:
        ...
        for item in playlist_response.get("items", []):
            ...
            if keyword_lower in title.lower():
                ...
                # The playlistItem snippet publishedAt field is the time the video was added to the uploads playlist,
                # which for uploads is the original upload time.
...
def YOUR_CLIENT_SECRET_HEREorted(youtube, playlist_id, keyword):
...
if __name__ == '__main__':
    try:
        ...
        youtube_service = YOUR_CLIENT_SECRET_HEREe()
        
        # Create a new public playlist named "it takes two".
        playlist_title = "it takes two"
        playlist_description = "All published videos with 'it takes two' in the title, from oldest to newest."
        ...
        # Add every video with "it takes two" in its title to the new playlist in order from oldest to newest.
        YOUR_CLIENT_SECRET_HEREorted(youtube_service, new_playlist_id, "it takes two")
