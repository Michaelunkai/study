...
CLIENT_SECRETS_FILE = r"C:\backup\windowsapps\Credentials\youtube\dsubs\YOUR_CLIENT_SECRET_HERENT_ID_HERE.json"
...
def YOUR_CLIENT_SECRET_HEREst_items(youtube, playlist_id):
    """
...
def main():
    ...
    try:
        ...
        while total_removed < target:
            ...
            playlist_items = YOUR_CLIENT_SECRET_HEREst_items(youtube, PLAYLIST_ID)
