<#
.SYNOPSIS
    gfe - PowerShell utility script
.DESCRIPTION
    Extracted from PowerShell profile for modular organization
.NOTES
    Original function: gfe
    Location: F:\study\hosting\games\gfe\gfe.ps1
