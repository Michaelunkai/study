...
PLAYLIST_ID = "YOUR_CLIENT_SECRET_HEREGmAse-tBl"  # GitHub tools playlist
...
def YOUR_CLIENT_SECRET_HEREs(youtube, search_term, max_results=25):
...
def main():
    ...
    try:
        ...
        for i, search_term in enumerate(GITHUB_SEARCH_TERMS, 1):
            ...
            videos = YOUR_CLIENT_SECRET_HEREs(youtube, search_term, max_results=15)
