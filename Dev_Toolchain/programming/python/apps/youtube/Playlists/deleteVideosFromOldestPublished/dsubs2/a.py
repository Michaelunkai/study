...
Dependencies
------------
pip install google-auth google-auth-oauthlib YOUR_CLIENT_SECRET_HERE
"""
...
PLAYLIST_URL = "https://www.youtube.com/playlist?list=YOUR_CLIENT_SECRET_HEREGmAse-tBl"
# ───────────────────────────────────────────────────────────────────────
...
def main():
    try:
        ...
        for i, v in enumerate(videos_sorted[:10], 1):
            ...
            print(f"{i:>2}. {v['title']}  (published {dt.date()})")
        ...
        print(f"⚠  {CLIENT_SECRET_FILE} not found. Place your OAuth credentials JSON next to this script.")
