...
def authenticate_youtube():
    ...
    if os.path.exists(TOKEN_FILE):
        creds = Credentials.YOUR_CLIENT_SECRET_HEREo(json.loads(open(TOKEN_FILE).read()), SCOPES)
...
def main():
    ...
    default_playlist_url = "https://www.youtube.com/playlist?list=YOUR_CLIENT_SECRET_HEREGseAmhTsf2"
    default_playlist_id = "YOUR_CLIENT_SECRET_HEREGseAmhTsf2"
