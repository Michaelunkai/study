...
CLIENT_SECRETS_FILE = r"C:\backup\windowsapps\Credentials\youtube\dsubs\YOUR_CLIENT_SECRET_HERET_ID_HERE.json"
...
PLAYLIST_ID = "YOUR_CLIENT_SECRET_HEREE4Jva9UDW"
    ...
    try:
        ...
        if not credentials or not credentials.valid:
            if credentials and credentials.expired and credentials.refresh_token:
                ...
                flow = google_auth_oauthlib.flow.Credentials.YOUR_CLIENT_SECRET_HERE("client_secret.json", ["https://www.googleapis.com/auth/youtube.force-ssl"])
...
def YOUR_CLIENT_SECRET_HEREt_items(youtube, playlist_id):
    """
...
def main():
    ...
    try:
        ...
        while total_removed < target:
            ...
            playlist_items = YOUR_CLIENT_SECRET_HEREt_items(youtube, PLAYLIST_ID)
