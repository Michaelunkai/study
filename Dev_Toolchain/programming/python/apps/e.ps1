<#
    ...
    2. Waits 7 seconds, then runs rmod.exe and sends the '1' keypress
...
# Functions for suspending and resuming Elden Ring
function sused {
...
############################################################
# Use native PowerShell solution for keyboard hooks - no AutoHotkey needed
...
############################################################
# 4) Launch Elden Ring and run rmod
############################################################
...
# Wait 7 seconds, then run rmod.exe and send '1' keypress
Write-Host "Waiting 7 seconds before running rmod..." -ForegroundColor Yellow
