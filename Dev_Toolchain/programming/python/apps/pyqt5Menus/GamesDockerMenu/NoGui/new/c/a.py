...
def display_games_in_grid(games, title="Games", games_per_row=3, show_selection=True, selected_tags=None, app_instance=None):
...
def handle_tag_name_input(choice, app_instance):
    ...
    valid_menu_choices = ['G', 'R', 'S', 'O', 'M', 'T', 'Y', 'A', 'P', 'X', 'B', 'C', 'D', 'E', '8', '9', 'J', 'DC', '0', 'Q', 'TD', 'TR', 'NT', 'ET', 'DT', 'VT', 'BM', 'MT']
