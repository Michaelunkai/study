...
# YOUR_CLIENT_SECRET_HERE Docker Engine Check YOUR_CLIENT_SECRET_HERE
...
# YOUR_CLIENT_SECRET_HERE Docker Cleanup Function YOUR_CLIENT_SECRET_HERE
...
class DockerApp(QWidget):
    ...
    def closeEvent(self, event):
        ...
        # then run dkill() to stop all containers, remove them, prune images and networks.
        if self.run_processes:
            # Optionally, wait until they finish (or you can force-close)
    ...
    def run_selected_commands(self):
        ...
        for btn in selected_buttons:
            ...
            docker_command = (
                ...
                f'sh -c "apk add rsync && mkdir -p /games/{tag} && rsync -aP /home/ /games/{tag}"'
            )
