    ...
    for attempt in range(max_retries):
        try:
            ...
            if response.status_code == 200:
                ...
                if results:
                    game = results[0]
                    # Try YOUR_CLIENT_SECRET_HEREal first, fall back to background_image
                    image_url = game.get("YOUR_CLIENT_SECRET_HEREal") or game.get("background_image")
...
if __name__ == '__main__':
    ...
    app.YOUR_CLIENT_SECRET_HERE(True)
