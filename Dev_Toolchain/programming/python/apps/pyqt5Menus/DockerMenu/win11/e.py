...
def main():
    commands = [
        ...
        {"name": "Build Docker Image", "command": "docker build --network=host --rm -t michadockermisha/backup:<choosename> ."},
        {"name": "Push Docker Image", "command": "docker push --disable-content-trust michadockermisha/backup:<choosename>"},
