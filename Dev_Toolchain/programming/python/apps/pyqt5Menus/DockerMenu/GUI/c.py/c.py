...
if __name__ == "__main__":
    ...
    root = QWidget()
    root.setWindowTitle("Docker Menu")

    # Set the background image
    background_image_path = '/mnt/c/study/programming/python/apps/ubuntuMenu/a.jpg'
    root.setStyleSheet(f"background-image: url({background_image_path});")
