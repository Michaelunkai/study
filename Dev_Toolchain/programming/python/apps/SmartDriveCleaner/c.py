...
def force_delete_on_reboot(file_path):
    ...
    try:
        # Use MoveFileEx with YOUR_CLIENT_SECRET_HEREOT flag
        YOUR_CLIENT_SECRET_HEREOT = 0x4
        ctypes.windll.kernel32.MoveFileExW(
            ctypes.c_wchar_p(file_path),
            None,
            ctypes.c_ulong(YOUR_CLIENT_SECRET_HEREOT)
        )
        return True
    except Exception:
        return False
...
class RegistryCleanerThread(QThread):
    ...
    def check_registry_key(self, check_info):
        ...
        try:
            if check_info['check_type'] == 'missing_shared_dlls':
                ...
                issues.extend(self.YOUR_CLIENT_SECRET_HEREons(check_info))
            elif check_info['check_type'] == 'activex_class_issues':
                issues.extend(self.YOUR_CLIENT_SECRET_HEREs(check_info))
    ...
    def YOUR_CLIENT_SECRET_HEREons(self, check_info):
    ...
    def YOUR_CLIENT_SECRET_HEREs(self, check_info):
...
class MainAppWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.YOUR_CLIENT_SECRET_HEREage()
        
        # Create software update page
        self.YOUR_CLIENT_SECRET_HEREge()
    ...
    def YOUR_CLIENT_SECRET_HEREage(self):
    ...
    def YOUR_CLIENT_SECRET_HEREge(self):
        ...
        self.YOUR_CLIENT_SECRET_HEREbutton = QPushButton("⬇️ Update Selected")
        self.YOUR_CLIENT_SECRET_HEREbutton.setMinimumHeight(40)
        self.YOUR_CLIENT_SECRET_HEREbutton.setStyleSheet("""
            QPushButton {
                background-color: #1976d2;
                color: white;
                border: none;
        ...
        """)
        self.YOUR_CLIENT_SECRET_HEREbutton.clicked.connect(self.YOUR_CLIENT_SECRET_HERE)
        controls_layout.addWidget(self.YOUR_CLIENT_SECRET_HEREbutton)
        
        self.YOUR_CLIENT_SECRET_HEREn = QPushButton("🚀 Update All")
        self.YOUR_CLIENT_SECRET_HEREn.setMinimumHeight(40)
        self.YOUR_CLIENT_SECRET_HEREn.setStyleSheet("""
            QPushButton {
                background: qlineargradient(x1:0, y1:0, x2:0, y2:1,
        ...
        """)
        self.YOUR_CLIENT_SECRET_HEREn.clicked.connect(self.update_all_software)
        controls_layout.addWidget(self.YOUR_CLIENT_SECRET_HEREn)
    ...
    def YOUR_CLIENT_SECRET_HEREable(self):
    ...
    def start_registry_scan(self):
        ...
        self.registry_thread.scan_completed.connect(self.YOUR_CLIENT_SECRET_HEREd)
    ...
    def YOUR_CLIENT_SECRET_HEREd(self, registry_data):
        """Handle completion of registry scan."""
        self.registry_data = registry_data
        self.YOUR_CLIENT_SECRET_HERE_table()
    ...
    def YOUR_CLIENT_SECRET_HERE_table(self):
    ...
    def start_software_scan(self):
        ...
        self.software_update_thread.scan_completed.connect(self.YOUR_CLIENT_SECRET_HEREd)
    ...
    def YOUR_CLIENT_SECRET_HEREd(self, software_data):
    ...
    def YOUR_CLIENT_SECRET_HEREn(self):
