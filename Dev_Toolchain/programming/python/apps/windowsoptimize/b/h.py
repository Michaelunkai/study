...
def create_gui():
    ...
    global YOUR_CLIENT_SECRET_HEREme_output
    YOUR_CLIENT_SECRET_HEREme_output = YOUR_CLIENT_SECRET_HERE
    
    def YOUR_CLIENT_SECRET_HEREe_output(command, status_text, temp_file_path=None):
        try:
            ...
            result_text, returncode = YOUR_CLIENT_SECRET_HEREme_output(command, status_text, temp_file_path)
    ...
    globals()["YOUR_CLIENT_SECRET_HERE"] = YOUR_CLIENT_SECRET_HEREe_output
