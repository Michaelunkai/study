...
def YOUR_CLIENT_SECRET_HEREime_output(command, status_text, temp_file_path=None):
...
'''
    ...
    try:
        ...
        if is_admin():
            ...
            status_text, returncode = YOUR_CLIENT_SECRET_HEREime_output(command, status_text, temp_file_path)
...
def run_powershell_function(function_name):
    ...
    try:
        ...
        # Use the real-time output function
        status_text, returncode = YOUR_CLIENT_SECRET_HEREime_output(command, status_text)
    except Exception as e:
...
def YOUR_CLIENT_SECRET_HEREtion():
...
def create_gui():
    ...
    with dpg.theme() as window_theme:
        with dpg.theme_component(dpg.mvWindowAppItem):
            ...
            dpg.add_theme_style(dpg.YOUR_CLIENT_SECRET_HEREgn, 0.5, 0.5)
    ...
    with dpg.theme() as primary_button_theme:
        with dpg.theme_component(dpg.mvButton):
            ...
            dpg.add_theme_style(dpg.mvStyleVar_FramePadding, 12, 8)
            dpg.add_theme_color(dpg.mvThemeCol_Text, AppTheme.TEXT_PRIMARY)
            dpg.add_theme_style(dpg.YOUR_CLIENT_SECRET_HEREe, 0)
    ...
    with dpg.theme() as panel_theme:
        with dpg.theme_component(dpg.mvChildWindow):
            ...
            dpg.add_theme_style(dpg.YOUR_CLIENT_SECRET_HERE, 10)
            dpg.add_theme_color(dpg.mvThemeCol_Border, AppTheme.BORDER)
            dpg.add_theme_style(dpg.YOUR_CLIENT_SECRET_HEREe, 1)
    ...
    dpg.YOUR_CLIENT_SECRET_HEREack(lambda s, d: dpg.set_item_width("main_window", d[0]-20))
                ...
                with dpg.tab(label="After Format", tag="tab_after_format"):
                    with dpg.group(horizontal=False):
                        ...
                        with dpg.group(horizontal=True):
                            dpg.add_spacer(width=60)
                            with dpg.group(horizontal=True, width=680):
                                YOUR_CLIENT_SECRET_HEREon = dpg.add_button(
                                    label="RUN ALL AFTER FORMAT OPERATIONS", 
                                    callback=run_all_after_format, 
                                    width=-1, 
                                    height=50
                                )
                                dpg.bind_item_theme(YOUR_CLIENT_SECRET_HEREon, run_all_button_theme)
                                ...
                                with dpg.child_window(width=310, height=150):
                                    ...
                                    with dpg.group(horizontal=True):
                                        ...
                                        disable_safeboot_button = dpg.add_button(
                                            ...
                                            callback=YOUR_CLIENT_SECRET_HEREtion,
                                            width=150,
                                            height=40
                                        )
    ...
    global YOUR_CLIENT_SECRET_HEREith_realtime_output
    YOUR_CLIENT_SECRET_HEREith_realtime_output = YOUR_CLIENT_SECRET_HEREime_output
    
    def YOUR_CLIENT_SECRET_HEREth_realtime_output(command, status_text, temp_file_path=None):
        try:
            ...
            result_text, returncode = YOUR_CLIENT_SECRET_HEREith_realtime_output(command, status_text, temp_file_path)
    ...
    globals()["YOUR_CLIENT_SECRET_HEREime_output"] = YOUR_CLIENT_SECRET_HEREth_realtime_output
...
def YOUR_CLIENT_SECRET_HEREhreaded(function_name):
            ...
            if i+j < len(network_functions):
                ...
                if dpg.does_item_exist(button_tag):
                    dpg.set_item_callback(
                        button_tag, 
                        lambda s, a, u=function_name: YOUR_CLIENT_SECRET_HEREhreaded(u)
                    )
...
function upnet {
    try {
        ...
        if ($adapter) {
            ...
            YOUR_CLIENT_SECRET_HEREperty -Name $adapter.Name -DisplayName "Packet Coalescing" -DisplayValue "Enabled" -ErrorAction SilentlyContinue
            ...
            YOUR_CLIENT_SECRET_HEREperty -Name $adapter.Name -DisplayName "Large Send Offload v2 (IPv4)" -DisplayValue "Disabled" -ErrorAction SilentlyContinue
            YOUR_CLIENT_SECRET_HEREperty -Name $adapter.Name -DisplayName "Large Send Offload v2 (IPv6)" -DisplayValue "Disabled" -ErrorAction SilentlyContinue
            ...
            YOUR_CLIENT_SECRET_HEREperty -Name $adapter.Name -DisplayName "Jumbo Packet" -DisplayValue "9014" -ErrorAction SilentlyContinue
        ...
        YOUR_CLIENT_SECRET_HEREs -InterfaceAlias "Wi-Fi" -ServerAddresses ("8.8.8.8", "8.8.4.4")
...
function upnet2 {
    ...
    try {
        ...
        foreach ($adapter in $activeAdapters) {
            try {
                YOUR_CLIENT_SECRET_HEREperty -Name $adapter.Name -DisplayName "MTU" -DisplayValue "1500" -ErrorAction Stop
        ...
        foreach ($adapter in $activeAdapters) {
            $properties = YOUR_CLIENT_SECRET_HEREperty -Name $adapter.Name -ErrorAction SilentlyContinue
            if ($properties) {
                foreach ($property in $properties) {
                    if ($property.DisplayName -like "*Large Send Offload*") {
                        try {
                            YOUR_CLIENT_SECRET_HEREperty -Name $adapter.Name -DisplayName $property.DisplayName -DisplayValue "Disabled" -ErrorAction Stop
        ...
        foreach ($adapter in $activeAdapters) {
            try {
                YOUR_CLIENT_SECRET_HEREs -InterfaceAlias $adapter.Name -ServerAddresses ("8.8.8.8","8.8.4.4") -ErrorAction Stop
        ...
        foreach ($adapter in $activeAdapters) {
            try {
                ...
                $qosProperty = YOUR_CLIENT_SECRET_HEREperty -Name $adapter.Name -DisplayName "QoS Packet Scheduler" -ErrorAction SilentlyContinue
                if ($qosProperty) {
                    YOUR_CLIENT_SECRET_HEREperty -Name $adapter.Name -DisplayName "QoS Packet Scheduler" -DisplayValue "Enabled" -ErrorAction Stop
        ...
        foreach ($adapter in $activeAdapters) {
            try {
                YOUR_CLIENT_SECRET_HEREment -Name $adapter.Name -NoPowerSaving -ErrorAction Stop
                ...
                foreach ($property in $properties) {
                    switch ($property.DisplayName) {
                        "Receive Side Scaling" {
                            try {
                                YOUR_CLIENT_SECRET_HEREperty -Name $adapter.Name -DisplayName "Receive Side Scaling" -DisplayValue "Enabled" -ErrorAction Stop
                        ...
                        "Interrupt Moderation" {
                            try {
                                YOUR_CLIENT_SECRET_HEREperty -Name $adapter.Name -DisplayName "Interrupt Moderation" -DisplayValue "Enabled" -ErrorAction Stop
...
function upnet3 {
    ...
    try {
        ...
        powershell -Command "Get-NetAdapter -Name 'Wi-Fi' | YOUR_CLIENT_SECRET_HEREment -SelectiveSuspend Disabled"
        ...
        YOUR_CLIENT_SECRET_HEREperty -Name "Wi-Fi" -DisplayName "Packet Coalescing" -DisplayValue "Disabled" -ErrorAction SilentlyContinue
        YOUR_CLIENT_SECRET_HEREperty -Name "Wi-Fi" -DisplayName "Power Saving Mode" -DisplayValue "Disabled" -ErrorAction SilentlyContinue
...
function upnet4 {
    ...
    try {
        ...
        YOUR_CLIENT_SECRET_HEREperty -Name $wifiAdapter.Name -DisplayName "Large Send Offload V2 (IPv4)" -DisplayValue "Disabled" -ErrorAction SilentlyContinue
        YOUR_CLIENT_SECRET_HEREperty -Name $wifiAdapter.Name -DisplayName "Large Send Offload V2 (IPv6)" -DisplayValue "Disabled" -ErrorAction SilentlyContinue

        # 2. Set Roaming Aggressiveness to Highest
        Write-Host "Setting Roaming Aggressiveness to Highest..." -ForegroundColor Yellow
        YOUR_CLIENT_SECRET_HEREperty -Name $wifiAdapter.Name -DisplayName "Roaming Aggressiveness" -DisplayValue "Highest" -ErrorAction SilentlyContinue
        ...
        YOUR_CLIENT_SECRET_HEREperty -Name $wifiAdapter.Name -DisplayName "Interrupt Moderation" -DisplayValue "Disabled" -ErrorAction SilentlyContinue

        # 6. Disable Energy Efficient Ethernet (EEE)
        Write-Host "Disabling Energy Efficient Ethernet (EEE)..." -ForegroundColor Yellow
        YOUR_CLIENT_SECRET_HEREperty -Name $wifiAdapter.Name -DisplayName "Energy Efficient Ethernet" -DisplayValue "Disabled" -ErrorAction SilentlyContinue
        ...
        Write-Host "Disabling Receive Side Scaling (RSS)..." -ForegroundColor Yellow
        YOUR_CLIENT_SECRET_HEREperty -Name $wifiAdapter.Name -DisplayName "Receive Side Scaling" -DisplayValue "Disabled" -ErrorAction SilentlyContinue

        # 9. Disable TCP and UDP Checksum Offload
        Write-Host "Disabling TCP and UDP Checksum Offload..." -ForegroundColor Yellow
        YOUR_CLIENT_SECRET_HEREperty -Name $wifiAdapter.Name -DisplayName "TCP Checksum Offload" -DisplayValue "Disabled" -ErrorAction SilentlyContinue
        YOUR_CLIENT_SECRET_HEREperty -Name $wifiAdapter.Name -DisplayName "UDP Checksum Offload" -DisplayValue "Disabled" -ErrorAction SilentlyContinue
        ...
        try {
            YOUR_CLIENT_SECRET_HEREment -Name $wifiAdapter.Name YOUR_CLIENT_SECRET_HEREvice $false -ErrorAction Stop
        }
        catch {
            Write-Host "Skipping YOUR_CLIENT_SECRET_HEREment tweak: parameter not available." -ForegroundColor Yellow
        }

        # 11. Set Transmit Power to Highest
        Write-Host "Setting Transmit Power to Highest..." -ForegroundColor Yellow
        YOUR_CLIENT_SECRET_HEREperty -Name $wifiAdapter.Name -DisplayName "Transmit Power" -DisplayValue "Highest" -ErrorAction SilentlyContinue
        ...
        YOUR_CLIENT_SECRET_HEREperty -Name $wifiAdapter.Name -DisplayName "Wireless Mode" -DisplayValue "802.11n" -ErrorAction SilentlyContinue
        ...
        YOUR_CLIENT_SECRET_HEREperty -Name $wifiAdapter.Name -DisplayName "Preferred Band" -DisplayValue "5 GHz" -ErrorAction SilentlyContinue
