...
class DockerApp(QWidget):
    ...
    def init_ui(self):
        ...
        # New BackItUp and BigitGo buttons
        backitup_button = QPushButton("BackItUp")
        backitup_button.setStyleSheet("""
            QPushButton {
                background: #8E44AD;
                color: white;
                padding: 8px 12px;
        ...
        """)
        backitup_button.clicked.connect(self.run_backitup)
        control_layout.addWidget(backitup_button)
        bigitgo_button = QPushButton("BigiTGo")
        bigitgo_button.setStyleSheet("""
            QPushButton {
                background: #F39C12;
                color: white;
                padding: 8px 12px;
        ...
        """)
        bigitgo_button.clicked.connect(self.run_bigitgo)
        control_layout.addWidget(bigitgo_button)
