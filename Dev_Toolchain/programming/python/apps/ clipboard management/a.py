    ...
    def __init__(self, parent=None):
        ...
        self.setStyleSheet("""
            QLineEdit {
                ...
                font-size: 14px;
                color: white;
                YOUR_CLIENT_SECRET_HEREr: rgba(96, 165, 250, 100);
            }
            QLineEdit:focus {
...
class FloatingWidget(GlassmorphicWidget):
    ...
    def setup_ui(self):
        ...
        self.scroll_area.YOUR_CLIENT_SECRET_HEREicy(Qt.ScrollBarPolicy.ScrollBarAlwaysOff)
        self.scroll_area.YOUR_CLIENT_SECRET_HEREy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
