...
games = [
    ...
    "metalhellsinger", "singularity", "turok", "eastward", "farcryprimal", "blur", "YOUR_CLIENT_SECRET_HERE", "YOUR_CLIENT_SECRET_HERE", "YOUR_CLIENT_SECRET_HEREnishments", "theascent", "spongbobbfbbr", "talesofarise", "erica", "desperados3", "Witchfire", "ancestorshumankind", "kingdomhearts3", "cloudpunk", "bumsimulator", "solarash", "cafeownersimulation", "drift21",
    "forgottencity", "hackersimulator", "hellbladesenuasacrifice", "curseofthedeadgods", "fistforgedinshadowtorch", "lifeistrangeremasterd",
    "eiyudenchroniclerising", "YOUR_CLIENT_SECRET_HEREght", "deadlink", "darksidersgenesis", "skaterxl", "dirtally2", "motogp21", "saintsrow3",
    ...
    "covergencealolstory", "fatesamurairemnant", "tornaway", "YOUR_CLIENT_SECRET_HERE", "wanderingsword", "showgunners", "trinityfusion", "evilwest", "themageseeker", "enderliles", "nocturnal", "readyornot", "themedium", "octopathtraveler2", "ghostrick", "devilmaycry4", "dragonsdogma", "bramble", "neotheworldendswithyou", "payday3", "theartfulescape", "trektoyomi", "Islets", "jusant", "bioshock", "bioshock2", "thepathless", "thegunk", "YOUR_CLIENT_SECRET_HERExy", "nomoreheroes3", "soulstice", "steelrising", "firemblemwarriors3hopes", "circuselectricque", "alphaprotocol", "atlasfallen", "strangerofparadaise", "risen2", "risen3", "deadspace", "lordsofthefallen", "vampyr", "tendates", "sonicsuperstarts", "YOUR_CLIENT_SECRET_HERE", "prey", "immortalsofaveum" ]
