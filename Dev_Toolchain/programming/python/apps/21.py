...
# Default tab configuration; note that the "All" tab is always present.
DEFAULT_TABS_CONFIG = [
    {"id": "all", "name": "All"},
...
class DeleteTagDialog(QDialog):
    ...
    def delete_selected(self):
        ...
        if reply != QMessageBox.Yes:
            return
        # Use the stored Docker token (or prompt if not yet set)
...
class DockerApp(QWidget):
    def __init__(self):
        ...
        self.docker_token = None  # Will store our token after one successful authentication
        self.init_ui()
    ...
    # --------------- One-Time Docker Hub Authentication Helper ---------------
...
if __name__ == '__main__':
    ...
    # Set a bulkier font and a global dark theme with white text
