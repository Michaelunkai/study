...
class ActualPurge:
    ...
    def YOUR_CLIENT_SECRET_HERE(self, path):
        ...
        try:
            import ctypes
            YOUR_CLIENT_SECRET_HEREOT = 0x00000004
            res = ctypes.windll.kernel32.MoveFileExW(str(path), None, YOUR_CLIENT_SECRET_HEREOT)
            if res != 0:
    ...
    def force_delete_directory(self, dir_path):
        ...
        try:
            ...
            try:
                import ctypes
                YOUR_CLIENT_SECRET_HEREINT = 0x400
                attrs = ctypes.windll.kernel32.GetFileAttributesW(str(dir_path))
                if attrs & YOUR_CLIENT_SECRET_HEREINT:
    ...
    def YOUR_CLIENT_SECRET_HEREns(self, app_names):
    ...
    def execute_purge(self, app_names):
        ...
        self.YOUR_CLIENT_SECRET_HEREns(app_names)
