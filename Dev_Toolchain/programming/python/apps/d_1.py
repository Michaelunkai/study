    ...
    def load_games(self):
        if os.path.exists('games_data.json'):
            ...
            self.all_games = [
                ...
                "YOUR_CLIENT_SECRET_HEREn", "GreedFall", "EiyudeNchronicle", "CrisisCoreFinalFantasy7",
            ...
            self.category_games = {
                "interactive": ["batmantts", "thexpanse", "beyond2souls", "detroitbecomehuman", "oxenfree2",
                                ...
                                "goodbyevolcanohigh", "YOUR_CLIENT_SECRET_HEREnishments", "lovetooeasily",
                ...
                "action": ["saintsrow3", "farcryprimal", "devilmaycry4", "godofwar", "deadspace",
                           ...
                           "YOUR_CLIENT_SECRET_HEREn", "furi", "witcher3", "fallout4", "oblivion",
                           ...
                           "firemblem3houses", "YOUR_CLIENT_SECRET_HEREn", "greedfall",
