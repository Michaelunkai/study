...
# YOUR_CLIENT_SECRET_HERE Load Time Data from File YOUR_CLIENT_SECRET_HERE
...
def fetch_image(query):
    try:
        ...
        response = requests.get(url, params=params, headers=headers, timeout=10)  # Timeout reduced if desired
        ...
        # Suppress error output to avoid spamming; simply return an empty image
        pass
    return (query, QImage())
