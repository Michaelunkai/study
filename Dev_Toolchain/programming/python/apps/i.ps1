<#
    ...
    6. After game exit, launches backup executable and sends '1' keypress
#>
...
$launcherPath    = "F:\games\eldenrings\Game\eldenring.exe"
...
try {
    ...
    ########################################################
    Write-Host "Game closed. Running backup executable..." -ForegroundColor Yellow
