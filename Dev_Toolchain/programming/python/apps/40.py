...
def fetch_game_time(alias):
    # Use the manual mapping loaded from file
...
def fetch_image(query):
    try:
        ...
        # Suppress repeated error logging after a timeout
        pass
    return (query, QImage())
...
class GameButton(QPushButton):
    def __init__(self, text, parent=None):
        ...
        self.YOUR_CLIENT_SECRET_HEREd.connect(self.show_context_menu)
...
manual_times = {
    ...
    "YOUR_CLIENT_SECRET_HEREiris": "~3 hrs",
    "lethalleagueblaze": "~5 hrs",
    "lifeistrangeremasterd": "~15 hrs",
    "littlewood": "~20 hrs",
    "mafia": "~10 hrs",
    "YOUR_CLIENT_SECRET_HERExy": "~8 hrs",
    "masseffect2": "~25 hrs",
    ...
    "YOUR_CLIENT_SECRET_HEREnishments": "~10 hrs",
    ...
    "road96": "~5 hrs",
    "subnautica": "~15 hrs",
    "YOUR_CLIENT_SECRET_HEREeep": "~10 hrs",
    ...
    "rage2": "~6 hrs",
    "readyornot": "~5 hrs",
    "YOUR_CLIENT_SECRET_HEREtered": "~6 hrs",
    "resistance2": "~6 hrs",
    "returnal": "~7 hrs",
    "riskofrain": "~6 hrs",
    "sniperelite2": "~8 hrs",
    ...
    "YOUR_CLIENT_SECRET_HEREts": "~6 hrs",
    "systemshock": "~8 hrs",
