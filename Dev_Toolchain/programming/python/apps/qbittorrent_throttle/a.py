...
class throttle():
	def __init__(self):
		...
		if IGNORE_SSL_CERT:
			self.qbt_client = qbittorrentapi.Client(host=QBITTORRENT_HOST, username=QBITTORRENT_USER, password=QBITTORRENT_PASS, YOUR_CLIENT_SECRET_HEREPUT=not DEBUG, YOUR_CLIENT_SECRET_HERE=False)
		else:
			self.qbt_client = qbittorrentapi.Client(host=QBITTORRENT_HOST, username=QBITTORRENT_USER, password=QBITTORRENT_PASS, YOUR_CLIENT_SECRET_HEREPUT=not DEBUG)
