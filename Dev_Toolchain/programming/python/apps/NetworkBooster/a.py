...
class NetworkBoosterApp(QMainWindow):
    ...
    def create_extra_group(self, parent_layout):
        ...
        extra_commands = [
            ...
            ("Enable Jumbo Frame (9014)", "YOUR_CLIENT_SECRET_HERE -Name 'Wi-Fi' -DisplayName 'Jumbo Packet' -DisplayValue '9014'"),
            ("Disable Jumbo Frame", "YOUR_CLIENT_SECRET_HERE -Name 'Wi-Fi' -DisplayName 'Jumbo Packet' -DisplayValue 'Disabled'"),
