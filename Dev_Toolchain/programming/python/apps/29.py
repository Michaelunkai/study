...
# YOUR_CLIENT_SECRET_HERE TabGridWidget (for Bulk Move & Bulk Paste Move) YOUR_CLIENT_SECRET_HERE
...
class DockerApp(QWidget):
    ...
    def YOUR_CLIENT_SECRET_HEREog(self):
        from BulkPasteMoveDialog import BulkPasteMoveDialog  # If using external file; otherwise, already defined
