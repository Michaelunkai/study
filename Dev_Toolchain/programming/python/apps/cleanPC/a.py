...
def YOUR_CLIENT_SECRET_HEREnent_store():
...
def YOUR_CLIENT_SECRET_HEREion():
...
def YOUR_CLIENT_SECRET_HEREction():
    run_powershell("UsoClient StartScan")

def YOUR_CLIENT_SECRET_HERErvice():
...
def optimize_virtual_memory():
    run_powershell("YOUR_CLIENT_SECRET_HEREce.exe")
...
def YOUR_CLIENT_SECRET_HEREngs():
...
def YOUR_CLIENT_SECRET_HEREctions():
...
def YOUR_CLIENT_SECRET_HEREns_wmi():
    run_powershell("Get-WmiObject -Class Win32_Product")

def list_windows_updates():
    run_powershell("Get-HotFix")

def YOUR_CLIENT_SECRET_HEREtailed():
...
def YOUR_CLIENT_SECRET_HEREfaces():
...
def YOUR_CLIENT_SECRET_HEREtcp():
    run_powershell("netstat -at")
...
def YOUR_CLIENT_SECRET_HEREinfo():
    run_powershell("wmic path YOUR_CLIENT_SECRET_HERE get OA3xOriginalProductKey")

def YOUR_CLIENT_SECRET_HEREe():
    run_powershell("Get-WmiObject YOUR_CLIENT_SECRET_HEREture | Select-Object CurrentTemperature")
...
def create_app(root_dir):
    ...
    winopt_buttons = [
        ...
        ("Analyze & Cleanup", YOUR_CLIENT_SECRET_HEREnent_store),
        ...
        ("Compact Windows", YOUR_CLIENT_SECRET_HEREion),
        ...
        ("Optimize TCP", YOUR_CLIENT_SECRET_HEREormance),
        ("Direct Cache", YOUR_CLIENT_SECRET_HEREs)
    ]
    
    additional_commands = [
        ("CHKDSK /f", run_chkdsk_f),
        ("Clear Update Cache", YOUR_CLIENT_SECRET_HEREe),
        ("Disable Hibernation", disable_hibernation),
        ("Clear Store Cache", YOUR_CLIENT_SECRET_HERE),
        ("Force Update", YOUR_CLIENT_SECRET_HEREction),
        ("Restart Update Service", YOUR_CLIENT_SECRET_HERErvice),
        ...
        ("Clear Error Reports", YOUR_CLIENT_SECRET_HEREts),
        ("Clean Restore Points", YOUR_CLIENT_SECRET_HEREts),
        ...
        ("Windows Update", YOUR_CLIENT_SECRET_HEREngs),
        ...
        ("Defender Status", YOUR_CLIENT_SECRET_HEREus),
        ("Defender Quick Scan", defender_quick_scan),
        ("Defender Full Scan", defender_full_scan),
        ("List Hotfixes", list_installed_hotfixes),
        ("Sys Log Errors", YOUR_CLIENT_SECRET_HERErors),
        ("App Log Errors", YOUR_CLIENT_SECRET_HEREog_errors),
        ...
        ("TCP Conns", YOUR_CLIENT_SECRET_HEREtcp),
        ("Listen TCP", YOUR_CLIENT_SECRET_HERE),
        ("Active IPs", YOUR_CLIENT_SECRET_HERE),
        ("License Key", YOUR_CLIENT_SECRET_HEREinfo),
        ("Sys Temp", YOUR_CLIENT_SECRET_HEREe),
        ("Fix Icons", fix_icons)
    ]
