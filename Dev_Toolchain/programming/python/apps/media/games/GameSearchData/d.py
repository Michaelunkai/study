...
# YOUR_CLIENT_SECRET_HEREYOUR_CLIENT_SECRET_HERE------------------
# DetailTabs: displays tabs for game details, HowLongToBeat info, and image gallery
...
class DetailTabs(QtWidgets.QTabWidget):
    ...
    def init_tabs(self):
        ...
        # Tab 3: Gallery: show multiple wallpapers/icons
    ...
    def format_details(self):
        ...
        # Build HTML with as many fields as possible.
        html = f"""
        <h1 style="font-size:32px; color:#ff7f7f">{title}</h1>
        <p style="font-size:18px; color:#8b0000"><i>{deck}</i></p>
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        # Detail area: a container for tabbed details
        ...
        # Set a new style sheet: light red background, larger bold fonts
        self.setStyleSheet("""
            QMainWindow { background-color: #ffe6e6; }
            QListWidget { font-size: 18px; padding: 8px; }
            QTextBrowser { font-size: 16px; }
            QPushButton { background-color: #ff7f7f; color: white; padding: 10px; border-radius: 6px; font-size: 16px; font-weight: bold; }
