...
class WishlistApp(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.update_game_label = tk.Label(self.games_frame, text="Update game:")
        ...
        self.update_game_button = tk.Button(self.games_frame, text="Update Game", command=self.update_game)
        ...
        self.update_movie_label = tk.Label(self.movies_frame, text="Update movie:")
        ...
        self.update_movie_button = tk.Button(self.movies_frame, text="Update Movie", command=self.update_movie)
        ...
        self.update_tv_show_label = tk.Label(self.tv_shows_frame, text="Update TV show:")
        ...
        self.update_tv_show_button = tk.Button(self.tv_shows_frame, text="Update TV Show", command=self.update_tv_show)
        ...
        self.update_anime_label = tk.Label(self.anime_frame, text="Update anime:")
        ...
        self.update_anime_button = tk.Button(self.anime_frame, text="Update Anime", command=self.update_anime)
