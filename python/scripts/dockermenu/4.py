...
class DockerApp(QWidget):
    ...
    def init_ui(self):
        ...
        self.all_games = [
    "Vampire Bloodlines", "control", "Road 96: Mile 0", "persona4", "outerworld", "sniperelite3",
    "batmantts", "doom", "pizzatower", "theradstringclub", "elpasoelswere", "rage2", "tloh", "brothers", "madmax", "witcher3", "hyperlightdrifter", "metroexodus", "transistor", "ftl", "returnal", "justcause3", "mafia", "rimword", "masseffect2", "deathstranding", "ghostrunner", "harvestmoon", "thexpanse", "moonstoneisland", "planetcoaster",
    "sleepingdogs", "gtviv", "thegreataceattorney", "goodbyevolcanohigh", "fallout4", "yakuza0", "vampiresurvivors", "highonlife", "unpacking", "haveanicedeath", "oblivion", "seaofstars", "citieskylines2", "kingdomofamalur", "wolfenstein2", "okamihd", "thesilentage", "divinityoriginalsin2", "dordogne", "theradstringclub", "cosmicshake", "alanwake", "plagtalerequirm", "sackboy", "remnant2", "sims4", "returntomonkeyisland", "beyond2soul", "oddworldsoulstorm", "slaytheprincess", "prisonsimulator", "videoverse", "singularity", "farcryprimal", "sherlockholmeschapterone", "sherlockholmestheawakened", "sherlockholmescrimesandpunishments", "theascent",
