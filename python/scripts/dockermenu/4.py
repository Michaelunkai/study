   ...
   "spongbobbfbbr", "talesofarise", "erica", "ancestorshumankind", "bumsimulator", "cafeownersimulation", "forgottencity", "hackersimulator", "hellbladesenuasacrifice", "curseofthedeadgods", "lifeistrangeremastered", "eiyudenchroniclerising",
    ...
    def update_games(self):
        ...
        if sender_button == self.interactive_button:
            specified_titles = ["batmantts", "erica","thexpanse", "beyond2souls", "detroitbecomehuman", "Oxenfree2", "forgottencity", "sherlockholmeschapterone", "masseffect2", "slaytheprincess", "tailsthebackbonepreludes", "lifeistrangeremastered", "goodbyevolcanohigh", "tornaway", "sherlockholmescrimesandpunishments", "thisbedwemade"
  ]
