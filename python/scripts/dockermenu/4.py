...
class DockerApp(QWidget):
   ...
   "spongbobbfbbr", "talesofarise", "erica", "ancestorshumankind", "bumsimulator", "cafeownersimulation", "forgottencity", "hackersimulator", "hellbladesenuasacrifice", "curseofthedeadgods", "lifeistrangeremastered", "eiyudenchroniclerising",
    ...
    "dragonsdogma", "bramble", "neotheworldendswithyou", "thegunk", "nomoreheroes3", "steelrising", "firemblemwarriors3hopes", "atlasfallen", "strangerofparadaise", "deadspace", "lordsofthefallen", "vampyr", "sonicsuperstarts", "seasonalettertothefuture", "supermariowonder", "trine2", "palworld", "turok", "dredge", "thecub", "tekken8", "tchia", "doubledragongaiden", "cultofthelamb", "thisbedwemade", "cosmicwheelsisterhood"
        ]
    ...
    def update_games(self):
        ...
        if sender_button == self.interactive_button:
            specified_titles = ["batmantts", "tellinglies", "erica","thexpanse", "beyond2souls", "detroitbecomehuman", "Oxenfree2", "forgottencity", "sherlockholmeschapterone", "masseffect2", "slaytheprincess", "tailsthebackbonepreludes", "lifeistrangeremastered", "goodbyevolcanohigh", "tornaway", "tellmewhy", "sherlockholmescrimesandpunishments", "thisbedwemade"
  ]
            ...
            specified_titles = ["sackboy", "trine2", "supermariowonder", "cosmicshake", "pseudoregalia", "kazeandthewildmasks", "haveanicedeath", "oddworldsoulstorm", "thelastfaith", "ugly", "enderliles", "covergence", "spongbobbfbbr", "neonabyss", "fistforgedinshadowtorch", "sonicsuperstarts", "blasphemous2", "nocturnal", "trinityfusion", "kfazeandthewildmasks", "thecub" ]
