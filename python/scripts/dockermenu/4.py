...
class DockerApp(QWidget):
    ...
    "batmantts", "doom", "pizzatower", "theradstringclub", "elpasoelswere", "rage2", "tloh", "brothers", "madmax", "witcher3", "hyperlightdrifter", "metroexodus", "transistor", "thesurge2", "ftl", "returnal", "justcause3", "mafia", "rimword", "masseffect2", "deathstranding", "ghostrunner", "harvestmoon", "thexpanse", "moonstoneisland", "planetcoaster",
