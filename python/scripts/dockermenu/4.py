...
class DockerApp(QWidget):
    ...
    "batmantts", "doom", "pizzatower", "theradstringclub", "tellmewhy", "elpasoelswere", "rage2", "judgment", "tloh", "brothers", "madmax", "witcher3", "hyperlightdrifter", "metroexodus", "transistor", "thesurge2", "ftl", "returnal", "justcause3", "starwars", "mafia", "rimword", "masseffect2", "deathstranding", "ghostrunner", "harvestmoon", "thexpanse", "moonstoneisland", "planetcoaster",
    "sleepingdogs", "gtviv", "pseudoregalia", "thegreataceattorney", "goodbyevolcanohigh", "fallout4","battlefieldbadcompany2", "yakuza0", "vampiresurvivors", "highonlife", "unpacking", "haveanicedeath", "oblivion", "seaofstars", "citieskylines2", "kingdomofamalur", "wolfenstein2", "okamihd", "thesilentage", "divinityoriginalsin2", "dordogne", "theradstringclub", "systemshockremake", "cosmicshake", "alanwake", "plagtalerequirm", "sackboy", "remnant2", "sims4", "returntomonkeyisland", "beyond2soul", "oddworldsoulstorm", "neonabyss", "gerda", "slaytheprincess", "prisonsimulator", "videoverse", "metalhellsinger", "singularity", "farcryprimal", "sherlockholmeschapterone", "sherlockholmestheawakened", "sherlockholmescrimesandpunishments", "theascent",
   "spongbobbfbbr", "talesofarise", "erica", "ancestorshumankind", "bumsimulator", "cafeownersimulation", "forgottencity", "hackersimulator", "hellbladesenuasacrifice", "curseofthedeadgods", "lifeistrangeremastered", "eiyudenchroniclerising",
    "darksidersgenesis", "skaterxl", "saintsrow3", "pacmanworldrepac", "inscryption", "brewmasterbeersimulator", "cheflifesimulator", "detroitbecomehuman", "seriousam4", "houseflipper", "enterthegungeon", "kfazeandthewildmasks", "blasphemous2", "deadisland2", "lostinplay", "blacktail", "thelastfaith", "godofwar", "sunsetoverdrive",    "killerfrequency", "deathmustdie", "punchclub2fastforward", "deusexhuman", "sludgelife2", "blackskylands", "notforbroadcast", "deeprockgalactic", "assassinscreedvalhalla", "frostpunk", "torchlight2", "nobodysavedtheworld", "oxenfree2", "spiritfarer", "furi", "metalgearsolidmaster", "ugly", "highlandsong", "venba", "covergence", "bombrushcyberfunk", "fatesamurairemnant", "tornaway", "tailsthebackbonepreludes", "wanderingsword", "showgunners", "trinityfusion", "evilwest", "themageseeker", "enderliles", "nocturnal", "octopathtraveler2", "devilmaycry4",
    "dragonsdogma", "bramble", "neotheworldendswithyou", "thegunk", "nomoreheroes3", "steelrising", "firemblemwarriors3hopes", "atlasfallen", "strangerofparadaise", "deadspace", "lordsofthefallen", "vampyr", "sonicsuperstarts", "seasonalettertothefuture", "supermariowonder", "trine2", "palworld", "turok", "dredge", "thecub", "tekken8", "tchia", "doubledragongaiden", "cultofthelamb", "thisbedwemade", "cosmicwheelsisterhood", "talesofvesperia", "torchlight2", "xenobladechronicles", "myfriendpedro", "okamihd", "trianglestrategy", "tenseiv", "braverlydefault2", "megamanbattlenetwork", "livealive", "advancedwars" "riskofrain", "driversanfrancisco", "signalis", "resistance2", "tinykin", "thedarkness", "thepunisher", "legendoftianding", "nier", "soulstice", "priceofpersia", "bugsnax", "zeldalinktothepast"
        ]
    ...
    def update_games(self):
        ...
        if sender_button == self.interactive_button:
            specified_titles = ["batmantts", "erica","thexpanse", "beyond2souls", "detroitbecomehuman", "Oxenfree2", "forgottencity", "sherlockholmeschapterone", "masseffect2", "slaytheprincess", "tailsthebackbonepreludes", "lifeistrangeremastered", "goodbyevolcanohigh", "tornaway", "tellmewhy", "sherlockholmescrimesandpunishments", "thisbedwemade"
  ]
