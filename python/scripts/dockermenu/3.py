...
class DockerApp(QWidget):
    ...
    def init_ui(self):
        ...
        games = [
        "Vampire Bloodlines", "control", "Scars Above", "Road 96: Mile 0", "Pentiment", "persona4", "codww2", "codghosts",
    ...
    "masseffect2", "deathstranding", "ghostrunner", "ghostrunner2", "harvestmoon", "thexpanse", "tellinglies", "moonstoneisland", "residentevilvillage", "residentevil4",
    ...
    "oddworldsoulstorm", "immortalsfenyxrising", "redout2", "neonabyss", "gerda", "slaytheprincess", "prisonsimulator", "videoverse",
    "metalhellsinger", "singularity", "turok", "farcryprimal", "blur", "sherlockholmeschapterone", "sherlockholmestheawakened", "sherlockholmescrimesandpunishments", "theascent", "spongbobbfbbr", "talesofarise", "erica", "desperados3", "Witchfire", "ancestorshumankind", "kingdomhearts3", "cloudpunk", "bumsimulator", "cafeownersimulation", "drift21",
