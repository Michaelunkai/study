...
class DockerApp(QWidget):
    ...
    def init_ui(self):
        ...
        games = [
        "Vampire Bloodlines", "control", "Scars Above", "Road 96: Mile 0", "Pentiment", "persona4", "codghosts", "outerworld", "sniperelite3",
    ...
    "masseffect2", "deathstranding", "ghostrunner", "ghostrunner2", "harvestmoon", "thexpanse", "tellinglies", "moonstoneisland",
    "planetcoaster", "sleepingdogs", "gtviv", "pseudoregalia", "thegreataceattorney", "goodbyevolcanohigh", "fallout4", "battlefieldbadcompany2", "yakuza0", 
    "vampiresurvivors", "highonlife", "thegodfather", "scarface", "unpacking", "scarletnexus", "haveanicedeath", "cultofthelamb", "oblivion",
    "seaofstars", "citieskylines2", "kingdomofamalur", "wolfenstein2", "okamihd", "thesilentage", "divinityoriginalsin2", "dordogne",
    ...
    "oddworldsoulstorm", "immortalsfenyxrising", "neonabyss", "gerda", "slaytheprincess", "prisonsimulator", "videoverse",
    "metalhellsinger", "singularity", "turok", "farcryprimal", "blur", "sherlockholmeschapterone", "sherlockholmestheawakened", "sherlockholmescrimesandpunishments", "theascent", "spongbobbfbbr", "talesofarise", "erica", "desperados3", "Witchfire", "ancestorshumankind", "kingdomhearts3", "bumsimulator", "cafeownersimulation", "drift21",
    "forgottencity", "hackersimulator", "hellbladesenuasacrifice", "curseofthedeadgods", "fistforgedinshadowtorch", "lifeistrangeremasterd",
    "eiyudenchroniclerising", "bloodsrainedritualofthenight", "darksidersgenesis", "skaterxl", "dirtally2", "motogp21", "saintsrow3",
    "pacmanworldrepac", "prodeus", "sniperghostwarriorcontracts", "inscryption", "brewmasterbeersimulator", "cheflifesimulator", "wreckfest", "detroitbecomehuman", "seriousam4", "houseflipper", "enterthegungeon", "kazeandthewildmasks", "blasphemous2", "deadisland2", "lostinplay", "blacktail", "midnightfightexpress", "theinvincible", "thelastfaith", "godofwar", "sunsetoverdrive", "shadowgambit", "thecaseofthegoldenidol", "armoredcore6firesofrubicon", "robocoproguecity", "mountandblade2bannerlord", "killerfrequency", "deathmustdie", "punchclub2fastforward", "davethediver", "deusexhuman", "dishonored2", "sludgelife2", "blackskylands", "notforbroadcast", "deeprockgalactic", "assassinscreedvalhalla", "frostpunk", "torchlight2", "torchlight3", "nobodysavedtheworld", "oxenfree2", "spiritfarer", "furi", "metalgearsolidmaster", "ugly", "highlandsong", "venba", "spacefortheunbound", "covergence", "bombrushcyberfunk", "americanarcadia",
    "covergencealolstory", "fatesamurairemnant", "tornaway", "tailsthebackbonepreludes", "wanderingsword", "showgunners", "trinityfusion", "evilwest", "themageseeker", "enderliles", "nocturnal", "readyornot", "themedium", "octopathtraveler2", "devilmaycry4", "dragonsdogma", "bramble", "neotheworldendswithyou", "payday3", "theartfulescape", "trektoyomi", "Islets", "thepathless", "thegunk", "marvelsguardiansofthegalaxy", "nomoreheroes3", "soulstice", "steelrising", "firemblemwarriors3hopes", "circuselectricque", "alphaprotocol", "atlasfallen", "strangerofparadaise", "risen2", "risen3", "deadspace", "lordsofthefallen", "vampyr", "tendates", "sonicsuperstarts", "seasonalettertothefuture", "prey", "immortalsofaveum", "supermariowonder", "trine2"
        ]
        row_num = 0
        col_num = 0
