...
class DockerApp(QWidget):
    ...
    "batmantts", "doom", "pizzatower", "theradstringclub", "elpasoelswere", "rage2", "tloh", "brothers", "madmax", "witcher3", "hyperlightdrifter", "metroexodus", "transistor", "ftl", "returnal", "justcause3", "rimword", "masseffect2", "deathstranding", "ghostrunner", "harvestmoon", "thexpanse", "moonstoneisland", "planetcoaster",
