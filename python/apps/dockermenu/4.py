...
class DockerApp(QWidget):
    ...
    def init_ui(self):
        ...
        self.all_games = [
    "Vampire Bloodlines", "control", "Road 96: Mile 0", "outerworld", "sniperelite3",
    "batmantts", "doom", "pizzatower", "theradstringclub", "elpasoelswere", "rage2", "tloh", "brothers", "madmax", "witcher3", "hyperlightdrifter", "metroexodus", "transistor", "ftl", "returnal", "justcause3", "masseffect2", "harvestmoon", "thexpanse", "moonstoneisland", "planetcoaster",
    "sleepingdogs", "gtviv", "thegreataceattorney", "goodbyevolcanohigh", "fallout4", "yakuza0", "vampiresurvivors", "highonlife", "haveanicedeath", "oblivion", "seaofstars", "citieskylines2", "kingdomofamalur", "wolfenstein2", "okamihd", "thesilentage", "divinityoriginalsin2", "dordogne", "theradstringclub", "cosmicshake", "plagtalerequirm", "sackboy", "remnant2", "sims4", "returntomonkeyisland", "beyond2soul", "oddworldsoulstorm", "slaytheprincess", "prisonsimulator", "videoverse", "singularity", "farcryprimal", "sherlockholmeschapterone", "sherlockholmestheawakened", "sherlockholmescrimesandpunishments", "theascent",
