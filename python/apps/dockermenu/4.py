...
class DockerApp(QWidget):
    ...
    "batmantts", "doom", "pizzatower", "theradstringclub", "elpasoelswere", "tloh", "brothers", "witcher3", "hyperlightdrifter", "metroexodus", "transistor", "ftl", "returnal", "justcause3", "masseffect2", "harvestmoon", "thexpanse", "moonstoneisland", "planetcoaster",
    "sleepingdogs", "gtviv", "thegreataceattorney", "goodbyevolcanohigh", "fallout4", "yakuza0", "vampiresurvivors", "highonlife", "oblivion", "seaofstars", "citieskylines2", "kingdomofamalur", "wolfenstein2", "okamihd", "thesilentage", "divinityoriginalsin2", "theradstringclub", "cosmicshake", "plagtalerequirm", "sackboy", "remnant2", "sims4", "returntomonkeyisland", "beyond2soul", "oddworldsoulstorm", "slaytheprincess", "prisonsimulator", "videoverse", "singularity", "farcryprimal", "sherlockholmeschapterone", "sherlockholmestheawakened", "sherlockholmescrimesandpunishments", "theascent",
   "spongbobbfbbr", "erica", "ancestorshumankind", "bumsimulator", "cafeownersimulation", "forgottencity", "hackersimulator", "hellbladesenuasacrifice", "lifeistrangeremastered", "eiyudenchroniclerising",
    ...
    def update_games(self):
        ...
        if sender_button == self.interactive_button:
            ...
            specified_titles = ["hackersimulator", "thecaseofthegoldenidol", "sludgelife2", "videoverse", "returnofthemonkeyisland", "divinityoriginalsin2", "cafeownersimulation", "notforbroadcast", "returntomonkeyisland", "thegreataceattorney" ]
        elif sender_button == self.shooter_button:
            specified_titles = ["doom", "sniperelite3", "deusexhuman", "elpasoelswhere", "theascent", "deeprockgalactic", "singularity", "evilwest", "turok", "resistance2", "thedarkness", "sniperghostwarrior2", "readyornot", "vanquish" "scarsabove", "witchfire" ]
            ...
            specified_titles = ["saintsrow3", "farcryprimal","devilmaycry4", "godofwar", "deadspace", "fatesamurairemnant", "sunsetoverdrive", "yakuza0", "hyperlightdrifter", "doom", "metroexodus", "sleepingdogs", "returnal", "kingdomofamalur", "wolfenstein2", "deadspace", "gtviv", "vampyr", "vampirebloodlines", "assassinscreedvalhalla", "neotheworldendswithyou", "thegunk", "darksidersgenesis", "steelrising", "theascent", "highonlife", "oblibion", "plagtalerequirm", "deadisland2", "metalgearsolidmaster", "transistor", "justcause3", "wanderingsword", "atlasfallen", "mountandblade2bannerlord", "ancestorshumankind", "seriousam4", "armoredcore6firesofrubicon", "furi", "nomoreheroes3", "dragonsdogma", "witcher3", "fallout4", "oblivion", "bombrushcyberfunk", "Vampire Bloodlines", "firemblemwarriors3hopes", "themageseeker", "control", "hellbladesenuasacrifice", "turok", "tekken8", "torchlight2", "talesofvesperia", "xenobladechronicles", "tenseiv", "riskofrain", "driversanfrancisco", "thedarkness", "thepunisher", "nier", "soulstice", "desperados3", "Immortalsofaveum", "alphaprotocol", "valkyriachronicles4", "enslaved", "marvel", "bayonetta2", "weirdwest", "ninokuni", "firemblemengage", "firemblem3houses", "armoredcore6firesofrubicon" ]
