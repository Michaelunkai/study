...
class WishlistApp(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.tv_shows_frame = tk.Frame(self.notebook)
        self.anime_frame = tk.Frame(self.notebook)
        ...
        self.add_game_label = tk.Label(self.games_frame, text="Add a game:")
        ...
        self.add_game_button = tk.Button(self.games_frame, text="Add Game", command=self.add_game)
        ...
        self.remove_game_button = tk.Button(self.games_frame, text="Remove Game", command=self.remove_game)
        ...
        self.add_movie_label = tk.Label(self.movies_frame, text="Add a movie:")
        ...
        self.add_movie_button = tk.Button(self.movies_frame, text="Add Movie", command=self.add_movie)
        ...
        self.remove_movie_button = tk.Button(self.movies_frame, text="Remove Movie", command=self.remove_movie)
        ...
        self.add_tv_show_label = tk.Label(self.tv_shows_frame, text="Add a TV show:")
        ...
        self.add_tv_show_button = tk.Button(self.tv_shows_frame, text="Add TV Show", command=self.add_tv_show)
        ...
        self.remove_tv_show_button = tk.Button(self.tv_shows_frame, text="Remove TV Show", command=self.remove_tv_show)
        ...
        self.add_anime_label = tk.Label(self.anime_frame, text="Add an anime:")
        ...
        self.add_anime_button = tk.Button(self.anime_frame, text="Add Anime", command=self.add_anime)
        ...
        self.remove_anime_button = tk.Button(self.anime_frame, text="Remove Anime", command=self.remove_anime)
