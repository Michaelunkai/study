...
class StickyNoteApp:
    def __init__(self, master):
        ...
        style = ttk.Style()
        style.configure("TEntry", padding=6, relief="flat", background='#FF0000', foreground='#000000', font=('Arial', 14))
        style.configure("TButton", padding=6, relief="flat", background='#FF0000', foreground='#000000', font=('Arial', 12))
        ...
        self.clear_button = ttk.Button(button_frame, text="Clear", command=self.clear_notes, style="TButton")  # Themed Button widget
