...
DOWNLOAD_DIR = os.path.expanduser("/mnt/c/Users/micha/pictures/back")

# Prompt the user for the number of wallpapers to download (1-1000)
num_wallpapers = input("Enter the number of wallpapers you would like to download (1-1000): ")

try:
    # Convert the user's input to an integer
    num_wallpapers = int(num_wallpapers)

    # Validate the input to ensure it's between 1 and 1000
    if num_wallpapers < 1 or num_wallpapers > 1000:
    ...
    for i in range(num_wallpapers):
        ...
        URL = f"https://source.unsplash.com/3840x2160/?dark&sig={i+1}"
