from PyQt5.QtWidgets import QApplication, QMainWindow, QTextEdit, QFileDialog, QAction, QFontDialog
...
class TextEditor(QMainWindow):
    ...
    def initUI(self):
        ...
        font_size_action.triggered.connect(self.changeFontSize)
        edit_menu.addAction(font_size_action)
    ...
    def changeFontSize(self):
        ...
        if selected_text:
            font, ok = QFontDialog.getFont(self.text_area.font(), self, "Select Font Size")
            if ok:
