...
# ====================
Write-Host "[0/20] Killing all Defender processes..." -ForegroundColor Yellow
$defenderProcesses = @(
...
# ====================
Write-Host "[1/20] Disabling UAC (IMMEDIATE)..." -ForegroundColor Yellow
...
Write-Host "  û UAC obliterated" -ForegroundColor Green

# ====================
# 2. DISABLE ALL DEFENDER SERVICES IMMEDIATELY
# ====================
Write-Host "[2/20] Disabling all Defender services (IMMEDIATE)..." -ForegroundColor Yellow
$services = @(
...
Write-Host "  û All services obliterated" -ForegroundColor Green

# ====================
# 3. TAKE OWNERSHIP OF DEFENDER FILES
# ====================
Write-Host "[3/20] Taking ownership of all Defender files..." -ForegroundColor Yellow
$defenderPaths = @(
...
Write-Host "  û Full ownership granted" -ForegroundColor Green

# ====================
# 4. DISABLE WINDOWS FIREWALL
# ====================
Write-Host "[4/20] Disabling Windows Firewall..." -ForegroundColor Yellow
...
Write-Host "  û Firewall obliterated" -ForegroundColor Green

# ====================
# 5. DISABLE DEFENDER MASTER SWITCHES
# ====================
Write-Host "[5/20] Disabling Defender master switches..." -ForegroundColor Yellow
...
Write-Host "  û Master switches obliterated" -ForegroundColor Green

# ====================
# 6. DISABLE REAL-TIME PROTECTION
# ====================
Write-Host "[6/20] Disabling Real-Time Protection..." -ForegroundColor Yellow
...
Write-Host "  û Real-time protection obliterated" -ForegroundColor Green

# ====================
# 7. DISABLE ALL SCANNING
# ====================
Write-Host "[7/20] Disabling all scanning..." -ForegroundColor Yellow
...
Write-Host "  û All scanning obliterated" -ForegroundColor Green

# ====================
# 8. DISABLE CLOUD PROTECTION
# ====================
Write-Host "[8/20] Disabling Cloud Protection..." -ForegroundColor Yellow
...
Write-Host "  û Cloud protection obliterated" -ForegroundColor Green

# ====================
# 9. DISABLE SIGNATURE UPDATES
# ====================
Write-Host "[9/20] Disabling signature updates..." -ForegroundColor Yellow
...
Write-Host "  û Signature updates obliterated" -ForegroundColor Green

# ====================
# 10. DISABLE TAMPER PROTECTION - FORCED
# ====================
Write-Host "[10/20] Disabling Tamper Protection (FORCED)..." -ForegroundColor Yellow
...
Write-Host "  û Tamper protection obliterated" -ForegroundColor Green

# ====================
# 11. DISABLE EXPLOIT GUARD
# ====================
Write-Host "[11/20] Disabling Exploit Guard..." -ForegroundColor Yellow
...
Write-Host "  û Exploit Guard obliterated" -ForegroundColor Green

# ====================
# 12. DISABLE SMARTSCREEN
# ====================
Write-Host "[12/20] Disabling SmartScreen..." -ForegroundColor Yellow
...
Write-Host "  û SmartScreen obliterated" -ForegroundColor Green

# ====================
# 13. DISABLE APPLICATION GUARD
# ====================
Write-Host "[13/20] Disabling Application Guard..." -ForegroundColor Yellow
$null = reg.exe add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\AppHVSI" /v "AllowAppHVSI_ProviderSet" /t REG_DWORD /d 0 /f 2>&1
Write-Host "  û Application Guard obliterated" -ForegroundColor Green

# ====================
# 14. DISABLE ATP
# ====================
Write-Host "[14/20] Disabling Advanced Threat Protection..." -ForegroundColor Yellow
...
Write-Host "  û ATP obliterated" -ForegroundColor Green

# ====================
# 15. DISABLE SECURITY NOTIFICATIONS
# ====================
Write-Host "[15/20] Disabling all security notifications..." -ForegroundColor Yellow
...
Write-Host "  û Notifications obliterated" -ForegroundColor Green

# ====================
# 16. GRANT FULL FILE SYSTEM PERMISSIONS (INSTANT)
# ====================
Write-Host "[16/20] Granting full file system permissions (INSTANT)..." -ForegroundColor Yellow
...
Write-Host "  û Permission restrictions removed (running in background)" -ForegroundColor Green

# ====================
# 17. DISABLE ALL NETWORK BLOCKING & RESTRICTIONS
# ====================
...
# Disable Windows Filtering Platform (DO NOT disable - causes network issues)
# Stop-Service -Name "BFE" -Force -ErrorAction SilentlyContinue
# Set-Service -Name "BFE" -StartupType Disabled -ErrorAction SilentlyContinue
...
Write-Host "  û All network blocking obliterated" -ForegroundColor Green
...
Write-Host "  û Windows Update disabled" -ForegroundColor Green

# ====================
# 19. DISABLE NETWORK PROTECTION & FILTERING
# ====================
...
Write-Host "  û Network protection obliterated" -ForegroundColor Green

# ====================
# 20. ENABLE FILE & PRINTER SHARING (NO RESTRICTIONS)
# ====================
...
Write-Host "  û File sharing fully enabled (no restrictions)" -ForegroundColor Green
...
Write-Host "  * Windows Filtering Platform (OFF)" -ForegroundColor White
...
Write-Host ""
Write-Host "To restore security: Run the enable.ps1 script" -ForegroundColor Yellow
Write-Host ""
