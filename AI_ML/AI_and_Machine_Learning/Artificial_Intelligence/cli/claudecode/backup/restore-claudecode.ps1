...
Write-Step "[1/16]" "Locating backup..."
...
Write-Step "[2/16]" "Validating backup integrity..."
...
Write-Step "[3/16]" "Stopping Claude Code processes..."
if (-not $DryRun) {
...
Write-Step "[4/16]" "Checking/Installing Node.js..."
...
Write-Step "[5/16]" "Checking/Installing Python..."
...
Write-Step "[6/16]" "Restoring npm global packages..."
...
Write-Step "[7/16]" "Restoring uvx/uv tools..."
...
Write-Step "[8/16]" "Restoring pnpm/yarn/nvm..."
...
Write-Step "[9/16]" "Restoring Claude Code configuration..."
Write-Host ""
...
Write-Step "[10/16]" "Restoring AppData directories..."
Write-Host ""
...
Write-Step "[11/16]" "Restoring npm claude-code packages..."
Write-Host ""
...
Write-Step "[12/16]" "Restoring PowerShell profiles..."
Write-Host ""
...
# Step 13: Restore registry and environment
Write-Step "[13/16]" "Restoring registry keys and environment variables..."
...
Write-Step "[14/16]" "Setting up MCP servers..."

if (-not $SkipMcpSetup -and -not $DryRun) {
    $mcpResults = Restore-McpServers -BackupPath $BackupPath
    Write-OK "MCP wrappers: $($mcpResults.wrappersRestored), Connected: $($mcpResults.serversConnected)"

    # Health check with auto-fix
    Write-Host ""
    Write-Step "[14b/16]" "Verifying MCP connections..."
...
# Step 15: Post-restore validation
Write-Step "[15/16]" "Running post-restore verification..."
Write-Host ""
...
# Step 16: Finalize
Write-Step "[16/16]" "Finalizing restore..."
