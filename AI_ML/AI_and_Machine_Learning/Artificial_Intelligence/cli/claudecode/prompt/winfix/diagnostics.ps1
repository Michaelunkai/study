...
Write-Host "========================================" -ForegroundColor Cyan
# Get-CimInstance DISABLED (WMI) | Select-Object Name, Command, Location | Format-Table -Wrap -AutoSize
