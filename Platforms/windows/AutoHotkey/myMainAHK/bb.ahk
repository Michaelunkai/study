        ...
        if (InStr(StrLower(textBuffer), StrLower(shortcut)) > 0) {
            ...
            if (command = "WALLPAPER_APP") {
                ...
                if (command = "WALLPAPER_APP") {
                    ...
                    try {
                        Run('powershell.exe -NoExit -Command "fit"')
                        LogMessage("TEXT_SHORTCUT: ggggg launched PowerShell with 'fit'")
                    } catch Error as e {
...
!a:: {
    try {
        Run('powershell.exe -NoExit -Command "whatsapp"')
        LogMessage("HOTKEY: Alt+A - Opened PowerShell and ran whatsapp")
    } catch Error as e {
