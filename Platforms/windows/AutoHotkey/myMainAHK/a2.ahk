...
LaunchClauTerminal() {
    try {
        ...
        TrayTip("CLAU DEBUG", "LaunchClauTerminal function called!", 3000)
        ...
        try {
            ...
            TrayTip("CLAU SUCCESS", "Windows Terminal opened with clau command", 2000)
            return
        } catch {
