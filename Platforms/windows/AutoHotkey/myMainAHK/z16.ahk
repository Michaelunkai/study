...
ShowHelpShortcuts() {
    try {
        ...
        leftColumnText .= "mailmy→Copy Email to Clipboard (michaelovsky22@gmail.com)`n"
        ...
        leftColumnText .= "uyuyuy→Open Terminal + Run WSL Ubuntu`n"
        ...
        leftColumnText .= "ytyt→YouTube | cxcx→Claude.ai`n"
        leftColumnText .= "cvcv→ChatGPT | gmail→Gmail Account 0`n"
        ...
        rightColumnText .= "ffff→Firefox | chrome→Chrome`n"
...
TrayTip("Complete Manager Ready - LATEST VERSION",
    ...
    "ytyt→YouTube with Auto-Login | unzipit→PowerShell ext | uninstall→BCUninstaller`n" .
