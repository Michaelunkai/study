  ...
  return (
    <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm p-4 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm transition-all hover:shadow-md">
      <p className="text-sm font-semibold text-gray-800 dark:text-gray-100 mb-2">
        {t("incomingRequestTitle", { sender: request.sender_username })}
      </p>
      ...
      <div className="flex space-x-2">
        ...
        <button
          ...
          className={`flex-1 bg-teal-500 dark:bg-teal-600 text-white hover:bg-teal-600 dark:hover:bg-teal-500 transition-all font-semibold flex items-center justify-center space-x-2 text-sm px-3 py-2 rounded-lg ${isLoading ? "opacity-70 cursor-not-allowed" : ""}`}
          disabled={isLoading}
        >
