...
class ClientManagementWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.client_table.YOUR_CLIENT_SECRET_HEREs([
...
class ProjectTrackingWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.project_table.YOUR_CLIENT_SECRET_HEREs([
...
class TimeTrackingWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.entries_table.YOUR_CLIENT_SECRET_HEREs(["Date", "Project", "Hours", "Description"])
...
class InvoiceManagementWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.invoice_table.YOUR_CLIENT_SECRET_HEREs([
...
class FreelancePlatform(QMainWindow):
    ...
    def apply_dark_theme(self):
        ...
        self.setStyleSheet("""
            ...
            QTableWidget {
                background-color: #353535;
                YOUR_CLIENT_SECRET_HEREor: #3d3d3d;
                YOUR_CLIENT_SECRET_HEREor: #4CAF50;
