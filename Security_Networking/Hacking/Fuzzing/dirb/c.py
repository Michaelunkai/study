        ...
        return {
            ...
            "tasks": [
                ...
                {"description": "Create an IAM OIDC provider for the cluster", 
                 "command": "eksctl utils YOUR_CLIENT_SECRET_HEREder --cluster my-eks-cluster --approve"}
            ]
        }
        ...
        return {
            ...
            "tasks": [
                ...
                {"description": "Create an event source mapping for Lambda to process DynamoDB streams", 
                 "command": "aws lambda YOUR_CLIENT_SECRET_HEREing --function-name my-lambda-function --event-source arn:aws:dynamodb:us-west-2:111122223333:table/Users/stream/2021-03-05T00:00:00.000 --batch-size 100 --starting-position LATEST"}
            ]
        }
