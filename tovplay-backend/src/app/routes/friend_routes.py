...
from src.api.friend_request_api import accept_invite_api, create_friend_request_api, block_user_api, unblock_user_api
...
def unblock_user():
    ...
    return unblock_user_api(sender_user_id, username_to_unblock)
...
def block_user():
    ...
    return block_user_api(sender_user_id, username_to_block)
...
@friend_request_bp.route("/<request_id>", methods=["DELETE"])
