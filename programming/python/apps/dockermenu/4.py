...
class DockerApp(QWidget):
    ...
    "batmantts", "doom", "theradstringclub", "elpasoelswere", "tloh", "brothers", "witcher3", "metroexodus", "transistor", "ftl", "returnal", "justcause3", "masseffect2", "harvestmoon", "thexpanse", "moonstoneisland", "planetcoaster",
    "sleepingdogs", "gtviv", "goodbyevolcanohigh", "fallout4", "oblivion", "seaofstars", "citieskylines2", "kingdomofamalur", "wolfenstein2", "okamihd", "thesilentage", "divinityoriginalsin2", "theradstringclub", "cosmicshake", "plagtalerequirm", "sackboy", "remnant2", "sims4", "returntomonkeyisland", "beyond2soul", "oddworldsoulstorm", "slaytheprincess", "prisonsimulator", "videoverse", "singularity", "farcryprimal", "sherlockholmeschapterone", "sherlockholmestheawakened", "sherlockholmescrimesandpunishments", "theascent",
   "spongbobbfbbr", "erica", "ancestorshumankind", "bumsimulator", "cafeownersimulation", "forgottencity", "hackersimulator", "hellbladesenuasacrifice", "lifeistrangeremastered", "eiyudenchroniclerising",
    ...
    def update_games(self):
        ...
        if sender_button == self.interactive_button:
            ...
            specified_titles = ["hackersimulator", "thecaseofthegoldenidol", "sludgelife2", "videoverse", "returnofthemonkeyisland", "divinityoriginalsin2", "cafeownersimulation", "notforbroadcast", "returntomonkeyisland", "slaytheprincess" ]
