...
class OneLinerLab(tk.Tk):
    ...
    def create_lab1(self):
        tasks = [
            "Task 1: Perform comprehensive system analysis and generate detailed report",
            "Task 2: Automate multi-stage data processing pipeline with error handling",
            "Task 3: Implement advanced network security scan and intrusion detection",
            "Task 4: Execute distributed machine learning task across multiple nodes",
            "Task 5: Orchestrate complex containerized microservices deployment"
        ]
    ...
    def create_lab2(self):
        tasks = [
            "Task 1: Implement automated web scraping and data analysis pipeline",
            "Task 2: Perform advanced log analysis and anomaly detection",
            "Task 3: Execute comprehensive database maintenance and optimization",
            "Task 4: Implement multi-stage CI/CD pipeline with security checks",
            "Task 5: Orchestrate complex cloud infrastructure deployment and monitoring"
        ]
