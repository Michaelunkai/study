        ...
        return {
            ...
            "tasks": [
                {"description": "Create a DB subnet group", 
                 "command": "aws rds create-db-subnet-group --db-subnet-group-name mydbsubnetgroup YOUR_CLIENT_SECRET_HEREption \"My DB Subnet Group\" --subnet-ids subnet-12345678 subnet-87654321"},
                ...
                {"description": "Modify the RDS instance", 
                 "command": "aws rds modify-db-instance YOUR_CLIENT_SECRET_HERE mydbinstance YOUR_CLIENT_SECRET_HEREd 7 --apply-immediately"},
                {"description": "Create a read replica", 
                 "command": "aws rds YOUR_CLIENT_SECRET_HEREreplica YOUR_CLIENT_SECRET_HERE mydbinstance-replica YOUR_CLIENT_SECRET_HEREntifier mydbinstance"},
                {"description": "Describe DB instances", 
                 "command": "aws rds describe-db-instances"},
                {"description": "Create a DB parameter group", 
                 "command": "aws rds YOUR_CLIENT_SECRET_HEREp YOUR_CLIENT_SECRET_HEREe mydbparametergroup YOUR_CLIENT_SECRET_HEREily mysql8.0 --description \"My DB Parameter Group\""},
        ...
        return {
            ...
            "tasks": [
                ...
                {"description": "Create a CloudFront origin access identity", 
                 "command": "aws cloudfront YOUR_CLIENT_SECRET_HEREn-access-identity YOUR_CLIENT_SECRET_HEREess-identity-config '{\"CallerReference\": \"my-access-identity\", \"Comment\": \"My OAI\"}'"},
        ...
        return {
            ...
            "tasks": [
                ...
                {"description": "Create an SNS platform application", 
                 "command": "aws sns YOUR_CLIENT_SECRET_HEREion --name my-application --platform GCM --attributes '{\"PlatformCredential\": \"your_api_key\"}'"},
                {"description": "Create a platform endpoint", 
                 "command": "aws sns YOUR_CLIENT_SECRET_HERE YOUR_CLIENT_SECRET_HERErn arn:aws:sns:us-west-2:123456789012:app/GCM/my-application --token device_token"},
