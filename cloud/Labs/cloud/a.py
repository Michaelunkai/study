    ...
    def get_service_steps(self):
        if self.current_service == "S3":
            ...
            return [
                ...
                "Add an inbound rule to the security group:\naws ec2 YOUR_CLIENT_SECRET_HERE-ingress --group-name MySecurityGroup --protocol tcp --port 22 --cidr 0.0.0.0/0",
            ...
            return [
                ...
                "Create an IAM role for Lambda:\naws iam create-role --role-name lambda-ex YOUR_CLIENT_SECRET_HEREument '{\"Version\": \"2012-10-17\",\"Statement\": [{ \"Effect\": \"Allow\", \"Principal\": {\"Service\": \"lambda.amazonaws.com\"}, \"Action\": \"sts:AssumeRole\"}]}'",
                "Attach permissions to the IAM role:\naws iam attach-role-policy --role-name lambda-ex --policy-arn arn:aws:iam::aws:policy/service-role/YOUR_CLIENT_SECRET_HEREole",
            ...
            return [
                ...
                f"Modify the RDS instance:\naws rds modify-db-instance YOUR_CLIENT_SECRET_HERE {db_instance_id} YOUR_CLIENT_SECRET_HEREd 7",
            ...
            return [
                ...
                f"List subscriptions:\naws sns YOUR_CLIENT_SECRET_HEREpic --topic-arn arn:aws:sns:REGION:ACCOUNT_ID:{topic_name}",
